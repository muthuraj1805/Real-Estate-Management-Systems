                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>To provide property sellers with tools and resources to list, market, and sell their properties efficiently.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our website provides a platform for landlords and tenants to connect, offering a wide range of rental properties across India.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our website allows property owners and real estate agents to list properties for sale or rent, reaching a large audience of potential buyers and tenants.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our website provides resources and guidance to help users make informed legal and investment decisions in real estate.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our website regularly publishes market reports and insights, helping buyers make informed decisions based on the latest trends in property prices, demand, and supply dynamics in various cities.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>The platform also features verified listings, which means the property details are authenticated by our website team, providing users with a higher level of trust and reliability.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> Our website allows users to rate and review properties based on their experiences. These reviews cover aspects such as the quality of construction, maintenance, location advantages, and value for money.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>The discussion forums on our website allow users to engage with each other, share experiences, ask questions, and get advice on real estate matters.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Reviews on our website provide firsthand accounts from property buyers and tenants, helping prospective buyers/renters understand the real condition and value of properties.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Acquiring properties through our website involves several steps facilitated by the platform to ensure a smooth transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
